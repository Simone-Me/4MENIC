...
include 'header.php';
include 'api.php';
?><link rel="stylesheet" href="detailed_info.css"><?php
...
<div class="info_movie">
    ...
    <?php endif; ?>
        ...
        <p><?=round($movie_detail["vote_average"], 2)?> / 10 sur <?=$movie_detail["vote_count"]?> vote <a href="comment.php"> <i class="bi bi-pencil-square"></i></a></p>
        <p></p>
        <p class="fs-5"><?=$movie_detail["overview"]?></p>
    </div>
    <img class="movie_image" src="https://image.tmdb.org/t/p/original/<?=$movie_detail["poster_path"]?>" alt="Card image cap">
    </div>
    ...
    <img class="photos-movie" src="https://image.tmdb.org/t/p/original/<?=$poster["file_path"]?>" alt="photo image movie">
    </div>
    <?php endforeach;?>
  </div>
</div>
