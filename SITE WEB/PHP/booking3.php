...
if (isset($_SESSION["user"])) {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        try {
            $sql = $conn->prepare("SELECT * FROM seance NATURAL JOIN salle natural join cinema WHERE idFilm = ? AND nomCine = ? AND nomSalle = ?;");
        ...
        <div class="m-5">
            <form id="booking3" action="bookingFilm.php" method="post" style="margin: 5vw; color: white;">
