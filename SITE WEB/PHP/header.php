...
<head>
 ...
 -->
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Dosis:wght@300&family=Rajdhani:wght@300&family=Ubuntu:wght@300&display=swap"
        rel="stylesheet">
 ...
 -->
    ...
    <link rel="stylesheet" href="/4MENIC/CSS/index.css">
    <link rel="stylesheet" href="/4MENIC/CSS/my_space.css">
...
<nav class="navbar menu navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/4MENIC/PHP/almanach.php">ALMANACH</a>
            </li>
        </ul>
