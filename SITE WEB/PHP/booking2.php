...
?> <div style="margin: 5vw; color: white;">
    <?php if (isset($_SESSION["user"])) {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            try {
                $sql2 = $conn->prepare("SELECT * FROM seance NATURAL JOIN salle, cinema WHERE idFilm = ? AND nomCine = ?;");
...
<div class="m-5">
    ...
    <form id="bookingFilm" action="booking3.php" method="post" style="margin: 5vw; color: white;">
